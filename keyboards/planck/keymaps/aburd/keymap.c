 ...
 * |----------+------+------+------+------+------+------+------+------+------+------+------|
 * | Mouse    |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Enter |
 * |----------+------+------+------+------+------+------+------+------+------+------+------|
 * | NumLayer |LClick| Alt  | GUI  |Lower |Shift |Space |Raise |ShLeft| Down |  Up  |Right |
 * `---------------------------------------------------------------------------------------'
 */
...
[_NUMBER] = LAYOUT_planck_grid(
    _______, _______, KC_F1,   KC_F2,   KC_F3,  KC_MUTE, KC_MPLY, KC_7, KC_8,   KC_9,    KC_DOT , _______,
    _______, _______, KC_F4,   KC_F5,   KC_F6,  KC_VOLD, KC_VOLU, KC_4, KC_5,   KC_6,    KC_DOT, _______,
    _______, _______, KC_F7,   KC_F8,   KC_F9,  KC_MPRV, KC_MNXT, KC_1, KC_2,   KC_3,    KC_DOT, _______,
    _______, _______, KC_F10,  KC_F11,  KC_F12, _______, _______, KC_0, KC_DOT, KC_DOT,  KC_DOT, _______
),
